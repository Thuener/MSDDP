...
T = 12
table = readcsv("5FF_BM100_Large_$(T)_table.csv") #TODO colocar como parametro
df2 = DataFrame()
...
N = 10 # Numer of lines on table.csv #TODO colocar como parametro
...
myplot =  plot(df2,ygroup="type",x="γ",y="M", ymin="Mmin", ymax="Mmax",color="Trans. cost",Geom.subplot_grid(Geom.line,Geom.errorbar)
